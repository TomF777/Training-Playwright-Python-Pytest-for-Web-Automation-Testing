"""
 Techniques which can be used to optimize tests. 
 This example shows how to skip over the resources which
 our test does not require (image, font, stylesheet, media)
"""
import pytest
